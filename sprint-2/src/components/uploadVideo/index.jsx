        ...
        <div className="upload-video__wrapper">
          ...
          <div className="upload-video__details">
            ...
            <div className="upload-video__form-group">
              ...
              <textarea className="upload-video__input" rows="4" placeholder="Add a description of your video" maxLength="600" required=""></textarea>
            </div>
          </div>
        </div>
        <div className="upload-video__button-wrapper">
          <button type="submit" className="button upload-video__button">PUBLISH</button>
          <button type="submit" className="button upload-video__button upload-video__button--different">CANCEL</button>
        </div>
      </form>
    </div>
  )
